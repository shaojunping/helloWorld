...
int main()
{
	...
	glfwWindowHint(GLFW_OPENGL_FORWARD_COMPAT, GL_TRUE); // uncomment this statement to fix compilation on OS X
														 ...
														 // --------------------
	GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "Light-casters-multi-lights", NULL, NULL);
	if (window == NULL)
	{
	...
	/*Shader ourShader("..//light//shader//4.1.lighting_maps.vs",
		"..//light//shader//4.1.lighting_maps.fs");*/
	Shader ourShader("..//light//shader//4.1.lighting_maps.vs",
		"..//light//shader//6.1.multiple_lights.fs");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		ourShader.setVec3("pointLights[0].ambient", pointLightColors[0] * 0.1f);
		...
		ourShader.setVec3("pointLights[1].ambient", pointLightColors[1] * 0.1f);
		...
		ourShader.setVec3("pointLights[2].ambient", pointLightColors[2] * 0.1f);
		...
		ourShader.setVec3("pointLights[3].ambient", pointLightColors[3] * 0.1f);
