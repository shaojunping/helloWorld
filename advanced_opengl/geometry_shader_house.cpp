...
int main()
{
	...
	Shader shader("..//advanced_opengl//shaders//9.1.geometry_shader.vs",
		"..//advanced_opengl//shaders//9.1.geometry_shader.fs",
		"..//advanced_opengl//shaders//9.1.geometry_shader.gs"
	);
