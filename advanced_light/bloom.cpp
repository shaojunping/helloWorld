...
int main()
{
	...
	// -------------------------
	Shader shader("..//advanced_light//shaders//7.bloom.vs", "..//advanced_light//shaders//7.bloom.fs");
	Shader shaderLight("..//advanced_light//shaders//7.bloom.vs", "..//advanced_light//shaders//7.light_box.fs");
	Shader shaderBlur("..//advanced_light//shaders//7.blur.vs", "..//advanced_light//shaders//7.blur.fs");
	Shader shaderBloomFinal("..//advanced_light//shaders//7.bloom_final.vs", "..//advanced_light//shaders//7.bloom_final.fs");


	// load textures
	// -------------
	unsigned int woodTexture = loadTexture("..//advanced_light//wood.png", true);
	unsigned int containerTexture = loadTexture("..//light//container2.png", true);
