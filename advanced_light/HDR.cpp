...
int main()
{
	...
	// -------------------------
	Shader shader("..//advanced_light//shaders//6.lighting.vs", "..//advanced_light//shaders//6.lighting.fs");
	Shader hdrShader("..//advanced_light//shaders//6.hdr.vs", "..//advanced_light//shaders//6.hdr.fs");
