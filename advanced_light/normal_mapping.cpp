...
int main()
{
	...
	Shader shader("..//advanced_light//shaders//4.normal_mapping.vs",
		"..//advanced_light//shaders//4.normal_mapping.fs");

	// load textures
	// -------------
	unsigned int diffuseMap = loadTexture("..//advanced_light//brickwall.jpg");
	unsigned int normalMap = loadTexture("..//advanced_light//brickwall_normal.jpg");
