...
int main()
{
	...
	glfwWindowHint(GLFW_OPENGL_FORWARD_COMPAT, GL_TRUE); // uncomment this statement to fix compilation on OS X
														 ...
														 // --------------------
	GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "Advanced Light", NULL, NULL);
	if (window == NULL)
	{
	...
	Shader shader("..//advanced_light//shaders//1.advanced_lighting.vs",
		"..//advanced_light//shaders//2.gamma_correction.fs");
	...
	unsigned int floorTexture                = loadTexture("..//advanced_light//wood.png", false);
