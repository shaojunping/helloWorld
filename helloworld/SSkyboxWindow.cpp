...
void SSkyboxWindow::Exec()
{
	...
	Shader skyboxShader("..//skyScatter//scatter.vs", "..//skyScatter//scatter.fs");
	skyboxShader.use();
	Model skybox("..//skyScatter//sky_02.fbx");
	unsigned int skyboxVAO = skybox.meshes[0].VAO;
	skyboxShader.setVec4("cBeginLenUV", 0.0f, 0.0f, 1.01, 2);
